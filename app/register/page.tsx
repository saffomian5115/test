...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error || "Registration me error aaya!");
        return;
      }
      ...
      setError("Server error ho gaya, baad me try karein!");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#6B5B45] via-[#8B7355] to-[#5C4A32] p-4">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 rounded-xl font-bold text-amber-950 transition-all duration-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed mt-2"
                style={{
                  background: loading
